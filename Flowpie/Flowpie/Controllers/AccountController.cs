...
namespace Flowpie.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            MyPrincipal user = new MyPrincipal(name, password);
            ...
            //    System.Data.DataSet ds = userHandle.Login(model.UserName, model.Password);
            ...
            //        role.Id = ds.Tables[0].Rows[0]["UserTypeID"].ToString();
            //        role.Name = ds.Tables[0].Rows[0]["UserTypeText"].ToString();
            ...
            //        //SignInAsync(user, false);//model.RememberMe
