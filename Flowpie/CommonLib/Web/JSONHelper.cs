...
namespace CommonLib.Web
{
    public class JSONHelper : IJSONHelper
    {
        ...
        protected System.Collections.ArrayList arrDataChildItem = new ArrayList();
        ...
        public void AddItem(string name, string value, bool isArray)
        {
            arrData.Add("\"" + name + "\":" + value);
            //if (isArray)
            //    arrData.Add("\"" + name + "\":" + value);
        ...
        public override string ToString()
        {
            ...
            else
            {
                foreach (string val in arrData)
                {
                    ...
                    {
                        tmpData = tmpData.Replace(",", "", tmpData.Length - 1, 1);
                        tmpData.Append("},");
